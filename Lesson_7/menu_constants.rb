module MenuConstants
  ...
  |--> 14 отображение мест в пассажирском вагоне|
  |--> 15 отображение объема в грузовом вагоне  |
  |--> 16 занять место в вагоне                 |
  |--> 17 Выход                                 |
  -----------------------------------------------
  MENU
  ...
  ENTER_SEATS = "Введите количество посадочных мест в вагоне(не более 99)"
  ENTER_VOLUME = "Введите объем грузового вагона(не более 99м2)"
  ENTER_VOLUME_PLACE ="Введите объем груза для загрузки"
end
