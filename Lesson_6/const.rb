module MenuConstants
  ...
  INCORRECT_NUMBER = "Неверый ввод, введите имя в формате '***'-'**' или '*****'"
  INVALID_STATION = "Имя не должно содержать цифры и быть менее 3 букв"
  INCORRECT_NUMBER_WAGON = "Неверный ввод, введите имя в формате '*' или '**'"
end
